...
$tkReportsRole = match ($currentRole) {
...
<body data-tk-reports-role="<?php echo htmlspecialchars($tkReportsRole); ?>">
<?php endif; ?>

<div class="content-area tk-reports-page" data-tk-reports-role="<?php echo htmlspecialchars($tkReportsRole); ?>">
    <div class="tk-reports-header">
        <div>
            <h1>Timekeeper Reports</h1>
            <p>Review operational reports submitted from all project sites.</p>
        </div>
    </div>
