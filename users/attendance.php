...
require_auth($conn, ['Assistant Admin', 'Payroll Staff', 'HR', 'Timekeeper']);
...
<!-- Dynamic table populated by JS -->
            ...
            <div class="attendance-pagination" style="display: flex; justify-content: space-between; align-items: center; margin-top: 16px; padding-top: 12px; border-top: 1px solid #e0e0e0;">
