...
<div><label>First Name</label><input type="text" id="newUserFirstName" placeholder="First name" maxlength="50" autocomplete="given-name" oninput="handleUserNameInput(event,'new')"><div class="field-validation-message" id="newUserFirstNameError" aria-live="assertive"></div></div>
<div><label>Last Name</label><input type="text" id="newUserLastName" placeholder="Last name" maxlength="50" autocomplete="family-name" oninput="handleUserNameInput(event,'new')"><div class="field-validation-message" id="newUserLastNameError" aria-live="assertive"></div></div>
</div>
<div><label>Email Address</label><input type="email" id="newUserEmail" placeholder="user@example.com" autocomplete="email" oninput="validateUserIdentityFields('new')"><div class="field-validation-message" id="newUserEmailError" aria-live="polite"></div></div>
...
<div class="name-fields-row">
<div><label>First Name</label><input type="text" id="editUserFirstName" placeholder="First name" maxlength="50" oninput="handleUserNameInput(event,'edit')"><div class="field-validation-message" id="editUserFirstNameError" aria-live="assertive"></div></div>
<div><label>Last Name</label><input type="text" id="editUserLastName" placeholder="Last name" maxlength="50" oninput="handleUserNameInput(event,'edit')"><div class="field-validation-message" id="editUserLastNameError" aria-live="assertive"></div></div>
</div>
<div><label>Email Address</label><input type="email" id="editUserEmail" placeholder="user@example.com" oninput="validateUserIdentityFields('edit')"><div class="field-validation-message" id="editUserEmailError" aria-live="polite"></div></div>
